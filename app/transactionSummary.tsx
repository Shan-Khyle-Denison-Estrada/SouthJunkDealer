    ...
    return (
        <View className="flex-1 gap-4 p-4">
            ...
            <View className="flex-1 flex-row gap-4 px-4">
                <TouchableOpacity className="bg-red-600 flex-1 place-content-center items-center rounded-md">
                ...
                <TouchableOpacity className="bg-primary flex-1 place-content-center items-center rounded-md">
                    <Text className="font-semibold text-2xl text-white">Add Item</Text>
                </TouchableOpacity>
                <TouchableOpacity className="bg-green-500 flex-1 place-content-center items-center rounded-md">
